        ...
        <header className="pos">
          <div className="topbanner">
            ...
            <div className="shortinfo">
              <p>
                She is currently studying MSI program (UX track) @ University of
                Michigan, Ann Arbor
                <br />
          ...
          <div className="myinfo">
            ...
            <div className="row">
              <div className="col-md-6">
                ...
                <p className="col-md-12 contactinfo">734 882 1102</p>
              </div>
              <div className="col-md-6 mail">
                ...
                <a className="col-md-12" href="mailto:xiaoyanw@umich.edu">
                  <p className="contactinfo mail">xiaoyanw@umich.edu</p>
                </a>
              </div>
            </div>
          </div>
